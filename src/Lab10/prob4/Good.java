...
public class Good {
    public static void main(final String[] args) {
        ...
        System.out.println(String.format("Editors with names that contains A, not contains E,"
                + " Length: 5: " + good.countWords(Folks.editors, 'a', 'e', 5)));
    ...
    public int countWords(List<String> words, char c, char d, int len) {
        return (int) words.stream()
                .filter(name -> name.indexOf(c) != -1 && name.indexOf(d) == -1 && name.length() == len).count();
    }
